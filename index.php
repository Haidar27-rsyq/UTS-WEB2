    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-body shadow" style="margin-auto;">
                <a href="tambahdata.php" class="btn btn-danger" >Add</a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="editdata.php?id=<?= $data['id']; ?>" class="btn btn-danger">Edit</a>
                                <a href="hapusdata.php?id=<?= $data['id']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile;?>
                    </tbody>
